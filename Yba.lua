...
local library = {
    version = "1.0.0",
    title = title or "GamingChair Hub " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Introduction()
    ...
    xsxLogo.Image = "http://www.roblox.com/asset/?id=127049115007097"
    ...
    hashLogo.Image = "http://www.roblox.com/asset/?id=127049115007097"
